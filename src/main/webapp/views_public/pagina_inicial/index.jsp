...
<head>
    ...
    <script src="${pageContext.request.contextPath}/views_public/pagina_inicial/script.js"></script>
</head>
<body>
    <header>
    ...
    <main>
        ...
        <section class="section_ofertas">
            <h2>Ofertas</h2>
            <div id="div_ofertas" class="div_produtos"></div>
        </section>
        <section id="img_01" class="section_ofertas">
            <h2>Produtos em Destaque</h2>
            <div id="div_produtos_destaque" class="div_produtos"></div>
        </section>
        <section class="section_ofertas">
            <h2>Todos os produtos</h2>
            <div id="div_todos_produtos" class="div_produtos"></div>
        </section>
